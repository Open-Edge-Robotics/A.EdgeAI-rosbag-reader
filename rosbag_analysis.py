...
# {'/tf_static': 'tf2_msgs/msg/TFMessage',
#  '/tf': 'tf2_msgs/msg/TFMessage',
def get_tf2_msgs(timestamps, msgs, msg_type):
...
#  '/navi_local_path': 'nav_msgs/msg/Path',
#  '/received_global_plan': 'nav_msgs/msg/Path',
def get_nav_msgs(timestamps, msgs, msg_type):
...
#  '/navi_motion_traj': 'navi_msgs/msg/Trajs'
def get_nav_msgs_trajs(timestamps, msgs, msg_type):
...
#  '/odom': 'nav_msgs/msg/Odometry',
def get_nav_msgs_odometry(timestamps, msgs, msg_type):
...
#  '/scan': 'sensor_msgs/msg/LaserScan'
def get_sensor_msgs_laserscan(timestamps, msgs, msg_type):
...
#  '/cmd_vel': 'geometry_msgs/msg/Twist'
def get_geometry_msgs_twist(timestamps, msgs, msg_type):
...
def get_geometry_msgs_posewithcovariancestamped(timestamps, msgs, msg_type):
...
def rosbag2dataframe(cursor, csv_file_path):
    
    topic_names = getAllTopicsNames(cursor, print_out=True)
    topic_types = getAllMsgsTypes(cursor, print_out=True)
    ...
    # csv_file_path = '/media/swstation/second/workspace-rosbag/rosbag-data'
    ...
    for topic_name, topic_type in zip(topic_names, topic_types):
        ...
        timestamps, msgs = getAllMessagesInTopic(cursor, topic_name, print_out=True)
        ...
        if topic_type == 'tf2_msgs/msg/TFMessage':    # '/tf'   '/tf_static'
            ...
            df = get_tf2_msgs(timestamps, msgs, msg_type)
...
def main():
    ...
    os.chdir('../../rosbag-data/navibag')
    os.getcwd()

    # bag_file = './ros2bag_2024-04-25.14_47_52/ros2bag_2024-04-25.14_47_52_0.db3'
    ...
    connect = sqlite3.connect(bag_file)
    cursor = connect.cursor()

    rosbag2dataframe(cursor, csv_file_path)
